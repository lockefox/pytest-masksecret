# -*- coding: utf-8 -*-
#
# pytest-masksecret documentation build configuration file, created by
...
project = u'pytest-masksecret'
copyright = u'2015, John Purcell'
...
man_pages = [
    (master_doc, 'pytest-cookiecutterplugin_name', u'pytest-masksecret Documentation',
     [author], 1)
]
